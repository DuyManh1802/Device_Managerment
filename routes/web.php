    ...
    Route::prefix('admin')->middleware('admin.login')->group(function(){
        ...
        Route::prefix('action')->group(function(){
            Route::prefix('department')->group(function(){
                ...
                Route::get('add-device-department', [departmentController::class, 'formAddDevice'])->middleware('can:isAdmin')->name('admin.action.department.get.add.device');
        ...
        Route::prefix('user')->middleware('can:isAdmin')->group(function(){
