    ...
    <div class="header-right">
        ...
        <div class="user-info-dropdown">
            <div class="dropdown">
                ...
                >
                    <a class="dropdown-item" href="{{ route('admin.login.profile') }}"
                        ><i class="dw dw-user1"></i>Thông tin người dùng</a
                    >
                    
                    <a class="dropdown-item" href="faq.html"
                        ><i class="dw dw-help"></i>Đổi mật khẩu</a
                    >
                    <a class="dropdown-item" href="{{ route('admin.login.index') }}"
